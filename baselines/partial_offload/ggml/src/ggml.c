...
static struct ggml_tensor * ggml_new_tensor_impl(
    ...
    // void * extra = view_src != NULL ? view_src->extra : NULL;
    int this_weight = 0;
    ...
    *result = (struct ggml_tensor) {
        ...
        /*.name         =*/ { 0 },
        /*.extra        =*/ NULL, // handed over from the CL side anyway.
...
#endif
{
    ...
    // printf("ggml_flash_attn_ext: (float)ne11 = %f\n", (float)ne11);
#else
    float params[] = { scale, max_bias, logit_softcap };
#endif
    ggml_set_op_params(result, params, sizeof(params));

    // printf("ggml_flash_attn_ext: sizeof(params) = %zu\n", sizeof(params));
