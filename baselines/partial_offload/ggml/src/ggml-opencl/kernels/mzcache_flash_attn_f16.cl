...
#endif
__kernel void kernel_mzcache_flash_attn_f16(
    ...
    const int ne0,  const int ne1,  const int ne2,  const int ne3)     /* dst */
{
    ...
    /*---------------------- shared buffers ------------------------------------*/
    __local half2 Ql[NCOLS][D/2];           /* 4 KB  */
    ...
    half2 VKQ [NCOLS/NWARPS][D/2/WARP]; // (16/4 , 64/32) = (4, 2) registers per column
