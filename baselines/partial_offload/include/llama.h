...
extern "C" {
    ...
    struct llama_context_params {
        ...
        // mzCache
        int32_t n_layers_to_alloc; // mzCache: number of layers to alloc for KVs at initial time.
    ...
    LLAMA_API size_t llama_model_get_n_tensors(const struct llama_model * model); // mzCache
// mzcache : This function is deprecated
//     LLAMA_API bool llama_model_unload_buffers(struct llama_model * model, const std::vector<int>& tensors_to_unload); // mzCache
    ...
    LLAMA_API bool llama_state_free_buffers(
                llama_context * ctx, 
                int layers_to_free);

    LLAMA_API bool llama_state_partial_alloc_load(llama_context * ctx,
                                    const char * filepath,
                                    llama_token * tokens_out,
                                    size_t   n_token_capacity,
                                    size_t * n_token_count_out,
