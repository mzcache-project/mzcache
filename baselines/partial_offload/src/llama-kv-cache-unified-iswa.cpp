...
bool llama_kv_cache_unified_iswa::state_free(int layers_to_free){
    std::cout << "ERROR state free not implemented for llama_kv_cache_unified_iswa" << "\n";
    return false;
}

bool llama_kv_cache_unified_iswa::state_alloc(int layers_to_free){
    std::cout << "ERROR state alloc not implemented for llama_kv_cache_unified_iswa" << "\n";
    return false;
}
