...
bool llama_memory_hybrid::state_free(int layers_to_free){
    std::cout << "ERROR state free not implemented for llama_memory_hybrid" << "\n";
    return false;
}

bool llama_memory_hybrid::state_alloc(int layers_to_free){
    std::cout << "ERROR state alloc not implemented for llama_memory_hybrid" << "\n";
    return false;
}
