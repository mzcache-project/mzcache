...
struct llama_model_loader {
    ...
    // Pin a single named tensor's page range in RAM via mlock (used by the
    // exp1_android_swap baseline to keep token_embd.weight from paging out).
    bool mlock_tensor_range_only(const char * name, llama_mlocks * mlock_mmaps);
#endif
